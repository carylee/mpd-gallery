  ...
  <h3><?php echo $this->Html->link('Add a new project', array('action'=>'add')); ?></h3>
    ...
    <td><?php echo $this->Html->link($project['Project']['title'], 
		...
		<td class="actions">
			...
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $project['Project']['id']), null, sprintf(__('Are you sure you want to delete "%s"?', true), $project['Project']['title'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
